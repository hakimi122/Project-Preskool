                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-sm-6">
                                            <div class="form-group">
                                                <label> ID</label>
                                                <input type="text" class="form-control" name="materialId" value="${materialEdit.materialId}" readonly="">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-6">
                                            <div class="form-group">
                                                <label>Material Name</label>
                                                <input type="text" class="form-control" name="materialName" value="${materialEdit.materialName}">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <select name="materialForRole">
                                                    <option value="teacher" <c:if test="${materialEdit.materialForRole eq 'teacher'}">selected</c:if>>Teacher</option>
                                                    <option value="student" <c:if test="${materialEdit.materialForRole eq 'student'}">selected</c:if>>Student</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-12 col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <c:forEach items="${subjects}" var="s">
                                                        <option value="${s.subjectId}" <c:if test="${materialEdit.subjectId eq s.subjectId}">selected</c:if>>${s.getSubjectName()}</option>
                                                    </c:forEach>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="materialDescription" value="${materialEdit.materialDescription}">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-6">
                                            <div class="form-group">
