                                    ...
                                    <form id="editClassForm" action="${contextPath}/exam" method="post">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-sm-6">
                                                <div class="form-group">
                                                    <select class="form-control" name="examType">
                                                        <option value="Midterm Exam" <c:if test="${c.examType == 'Midterm Exam'}">selected</c:if>>Midterm Exam</option>
                                                        <option value="Final Exam" <c:if test="${c.examType == 'Final Exam'}">selected</c:if>>Final Exam</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-12 col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <c:forEach items="${subjects}" var="t">
                                                            <option value="${t.subjectId}" <c:if test="${t.subjectId == c.subject.subjectId}">selected</c:if>>${t.subjectName}</option>
                                                        </c:forEach>
                                                    </select>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="slotSelect" name="slotId" onchange="updateTeachers()">
                                                        <c:forEach items="${slots}" var="t">
                                                            <option value="${t.slotId}" <c:if test="${t.slotId == c.getSlot().slotId}">selected</c:if>>${t.description}</option>
                                                        </c:forEach>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-12 col-sm-6">
                                                <div class="form-group">
                                                    <label>Date</label>
                                                    <input type="date" name="examDate" id="dateSelect" value="${c.examDate}" onchange="updateTeachers()"/>
                                                </div>
                                            </div>
                                            <div class="col-12 col-sm-6">
                                                <div class="form-group">
                                                    <label>Room</label>
                                                    <input type="text" class="form-control" name="room" value="${c.room}" required="">
                                                </div>
                                            </div>
                                            <div class="col-12 col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="supervisorSelect" name="teacherId">
                                                        <c:forEach items="${regularTeachers}" var="supervisor">
                                                            <option value="${supervisor.userId}" <c:if test="${supervisor.userId == c.teacher.userId}">selected</c:if>>${supervisor.fullName}</option>
                                                        </c:forEach>
                                                    </select>
                                                </div>
                                            </div>
