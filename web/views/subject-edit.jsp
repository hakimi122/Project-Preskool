...
<html lang="en">
    ...
    <body>
                ...
                <div class="content container-fluid">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-body">
                                    <form id="editClassForm" action="${contextPath}/subject" method="post">
                                        <div class="row">
                                            <div class="col-12">
                                            ...
                                            <div class="col-12 col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="subjectId" value="${subjectEdit.subjectId}" readonly="">
                                                </div>
                                            </div>
                                            <div class="col-12 col-sm-6">
                                                <div class="form-group">
                                                    <label>Subject Name</label>
                                                    <input type="text" class="form-control" name="subjectName" value="${subjectEdit.subjectName}">
                                                </div>
                                            </div>
                                            <div class="col-12 col-sm-6">
                                                <div class="form-group">
                                                    <label>IsTeaching?</label>
                                                    <input type="radio" class="form-control" name="isTeaching" value="true" id="isTeachingTrue"> Yes
                                                    <input type="radio" class="form-control" name="isTeaching" value="false" id="isTeachingFalse"> No
                                                </div>
                                            </div>
                                            <div class="col-12">
        ...
        <script>
            // Gi? s? subjectEdit.isTeaching là bi?n ch?a giá tr? true ho?c false.
            var isTeachingValue = "${subjectEdit.isTeaching}"; // Thay th? giá tr? này b?ng giá tr? th?c t? t? server n?u c?n

            // T? ??ng ch?n radio button d?a trên giá tr? c?a isTeachingValue
            document.addEventListener('DOMContentLoaded', function () {
                if (isTeachingValue === 'true') {
                    document.getElementById('isTeachingTrue').checked = true;
                } else if (isTeachingValue === 'false') {
                    document.getElementById('isTeachingFalse').checked = true;
                }
            });
        </script>
        <script>
