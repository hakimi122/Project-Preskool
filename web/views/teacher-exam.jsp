...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            <h1 class="mt-4 mb-4">Các lớp coi thi của giáo viên: ${sessionScope.user.userId} - ${sessionScope.user.fullName}</h1>
        ...
        <div style="text-align: center">        
            <a class="btn btn-primary" href="${contextPath}/teacher/dashboard">Back</a>
        </div>
        ...
        <script>
                    function sortExams() {
                        ...
                        window.location.href = '${contextPath}/exam-teacher?sortDate=' + sortValue;
                    }
        </script>
    </body>
</html>
