                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-sm-6">
                                                <div class="form-group">
                                                    <label>Class: ${cl.classId} - ${cl.className} - ${cl.year}</label>
                                                    <input type="hidden" class="form-control" name="classId" value="${cl.classId}">
                                                </div>
                                            </div>
                                            <div class="col-12 col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="subjectId" id="subjectSelect" onchange="updateTeachers()">
                                                        <c:forEach items="${subjects}" var="t">
                                                            <option value="${t.subjectId}">${t.subjectName}</option>
                                                        </c:forEach>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-12 col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="supervisorSelect" name="supervisorId" onchange="updateSlots()">
                                                        <c:forEach items="${defaultSupervisors}" var="supervisor">
                                            ...
                                            <div class="col-12 col-sm-6">
                                                <div class="form-group">
                                                    <label>Date</label>
                                                    <input type="date" name="date" id="dateSelect" onchange="updateSlots()"/>
                                                </div>
                                            </div>
                                            <div class="col-12 col-sm-6">
                                                <div class="form-group">
                                            ...
                                            <div class="col-12 col-sm-6">
                                                <div class="form-group">
                                                    <label for="statusId">Is Attanded?</label>
                                                    <div id="statusId" style="display: flex">
                                                        <input type="radio"  name="isActive" value="true" > True &nbsp;&nbsp;&nbsp;
                                                        <input type="radio"  name="isActive" value="false" checked=""> False
                                                    </div>
                                                </div>
                                            </div>
