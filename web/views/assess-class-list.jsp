                            ...
                            <div class="card card-table">
                                <div class="card-body">
                                    <div class="col-auto text-right float-right ml-auto">
                                        <form method="get" action="${contextPath}/assessment">
                                            <input type="hidden" name="action" value="list"/>
                                            <select name="year" onchange="this.form.submit()">
                                                <option value="-1" ${selectedYear == -1 ? 'selected' : ''}>All</option>
                                                ...
                                                <c:if test="${classes != null}">
                                                    <c:forEach items="${classes}" var="t">
                                                        <tr id="row_${t.classId}">
                                                            ...
                                                            <td class="text-right">
                                                                <div class="actions">
                                                                    <a href="${contextPath}/assessment?action=assess&classId=${t.classId}&year=${t.getYear()}" class="btn btn-outline-primary ml-2"></i>Assess</a>
                                                                    <c:if test="${sessionScope.user.getRole() == 'headmaster'}">
                                                                        <a href="${contextPath}/assessment?action=close&classId=${t.classId}" class="btn btn-sm bg-success-light mr-2 editBtn">
                                                                            Close Class
                                                                        </a>
                                                                    </c:if>
                                                                </div>
